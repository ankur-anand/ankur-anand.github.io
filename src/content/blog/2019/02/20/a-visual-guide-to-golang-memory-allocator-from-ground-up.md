---
title: "A Visual Guide to Go's Memory Allocator"
description: "A visual guide to Go's memory allocator, from virtual memory and TCMalloc to mspan, mcache, mcentral, mheap, arenas, and object allocation."
publishedAt: 2019-02-20
tags: ["Go","memory","internals"]
draft: false
socialImage: "/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-15-3a5c5aaa.png"
socialImageAlt: "Diagram showing Go memory allocator span classes, mspan lists, and mcentral."
canonicalUrl: "https://medium.com/@ankur_anand/a-visual-guide-to-golang-memory-allocator-from-ground-up-e132258453ed"
originalUrl: "https://blog.ankuranand.com/2019/02/20/a-visual-guide-to-golang-memory-allocator-from-ground-up/"
legacyUrls: ["https://blog.ankuranand.com/2019/02/20/a-visual-guide-to-golang-memory-allocator-from-ground-up/","https://medium.com/@ankur_anand/a-visual-guide-to-golang-memory-allocator-from-ground-up-e132258453ed"]
---
...
![A simple illustration of a Physical Memory Cell (Not an exact representation)](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-01-87c46873.png)
...
![Simple Illustration of how a Physical Memory Cell interacts with CPU](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-02-528ed38f.png)
...
![Illustrative Representation of an Address Line between CPU and Physical Memory.](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-03-d7f33c9c.png)
...
![Virtual Address Space Representation](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-04-5da07c58.jpg)
...
![This is **not** a physical diagram, only a depiction. address translation process not included for simplicity](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-05-b37177db.png)
...
![A simple assembly code asking for more heap memory.](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-06-38ac4c33.png)

*heap memory increment*
![heap memory increment](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-07-80ab2a0e.png)
...
![An external fragmentation demonstration](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-08-7c217516.png)
...
![Thread Cache (Each Thread gets this Thread Local Thread Cache)](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-09-0c39f8ab.png)
...
![Page Heap (for span management)](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-10-5e017306.png)
...
*Size Classes in Go*
![Size Classes in Go](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-11-c62e58b5.png)
...
![8 KB page divided into a size class of 1KB (In Go pages are maintained at the granularity of 8KB)](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-12-3172d2e0.png)
...
![Illustrative Representation of a mspan in Go memory allocator](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-13-d4acd989.png)
...
![Illustrative Representation of a Relationship between P, mcache, and mspan in Go.](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-14-2f8ef61e.png)
...
![Illustrative Representation of a mcentral](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-15-3a5c5aaa.png)
...
![Illustrative Representation of a mheap.](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-16-424417cc.png)
...
![process stats for a program](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-17-5c2f0b20.png)
...
*memory stats.*
![map and smap stats.](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-18-b62ccaaa.png)
...
![current incremental arena size on a different system.](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-19-cfbe9e6a.png)
...
*Single arena ( 64 MB ).*
![Single arena ( 64 MB ).](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-20-967f98c2.png)
...
![Visual Overview of Runtime Memory Allocator.](/images/blog/a-visual-guide-to-golang-memory-allocator-from-ground-up/image-21-0341eba3.png)
